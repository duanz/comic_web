    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('chapter_id', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='comic_admin.Chapter')),
                ('comic_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='comic_admin.Comic')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('update_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('key', models.CharField(default='', max_length=100, null=True, verbose_name='图片文件名')),
        ...
        migrations.AddField(
            ...
            name='img_id',
            field=models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='comic_admin.Image'),
        ),
        migrations.AddField(
